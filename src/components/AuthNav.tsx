  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        className="grid h-9 w-9 place-items-center rounded-lg bg-gradient-to-br from-indigo-500 to-violet-500 text-sm font-bold text-white"
      >
      ...
      <button
        ...
        title="Sign out"
        aria-label="Sign out"
        className="grid h-9 w-9 place-items-center rounded-lg border border-white/15 text-slate-300 transition-colors hover:bg-white/5 hover:text-rose-400"
      >
        <svg
          className="h-4 w-4"
          viewBox="0 0 24 24"
